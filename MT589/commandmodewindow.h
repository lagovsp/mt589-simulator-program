...
public:
    ...
    void readCurrentExecutedCommandMicroListing(size_t);
    void displayScannedMicroListing();

    std::pair<bool, std::bitset<9>> getNextAddress(microcommand);
...
public:
    ...
    std::vector<std::vector<QTableWidgetItem*>> microcommand_list_widget_matrix = {};
